...
const lessons = [
  ...
  /*{
    ...
    about: {
      ...
      text:
        ...
        "— учатся передавать настроение и характер изображения\n" +
    ...
    teacher: {
      id: "dolzhenkova-darya",
      name: "Долженкова Дарья Сергеевна",
      role: "Преподаватель",
      bio:
        "Высшее образование по специальности журналистика (МГУКИ), обучение в художественной школе и профессиональная переподготовка в сфере дошкольного воспитания.\n\n" +
        "Более семи лет работает воспитателем и развивает творческие способности детей: вела «Школу юного художника» в школе №878, сейчас руководит студией анимации в дошкольном корпусе школы №2083.",
      education: "",
      approach: "",
    },
...

  {
    ...
    about: {
      title: "О занятии",
      text:
        "Занятия по графике помогают заложить уверенную основу в рисовании\n\n" +
        "На уроках дети:\n" +
        ...
        "— рисуют быстрее и свободнее, без страха ошибки\n\n" +
        "Графика даёт фундамент, который полезен для любого направления в изобразительном искусстве",
    },
