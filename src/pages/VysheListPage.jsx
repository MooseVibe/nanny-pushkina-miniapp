...
const lessons = [
...

  {
    ...
    teacher: {
      name: "Рудич Артем Васильевич",
      role: "Преподаватель",
      education: "",
      approach: "",
      // bio специально НЕ добавляю — будет дефолтная заглушка из LessonDetailsPage
    },
  
    schedule: { sessions: [{ day: "СБ", time: "13:00" }] },
  },,
...

  {
    ...
    teacher: {
      ...
      role: "Преподаватель",
      // био пока не заполняем — информации нет
      education: "",
      approach: "",
    },
